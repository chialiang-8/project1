package com.lz.icehouse.common.persistence;
...
import com.lz.icehouse.common.utils.Reflections;
import com.lz.icehouse.common.utils.StringUtils;
...
/*		try {
	 ...
	 * */
    @SuppressWarnings("unchecked")
	public <E> T get(Class<T> entity, Integer id) {  
	    return (T) getSession().get(entity, id);  
	}  
	   
	public <E> void delete(T t) {  
		getSession().delete(t);  
	}  
	
	public <E> void delete(Class<T> entity, Integer id) {
		System.out.println("--------------------------------------------0000000000sfdsfsfd");
		getSession().beginTransaction().begin();;
		T t = get(entity, id);
		if(null != t){
			System.out.println("----------1----------------------------------0000000000sfdsfsfd");
			getSession().delete(t);
			System.out.println("----------2----------------------------------0000000000sfdsfsfd");
		}
